    ...
    <div class="flex-1 overflow-y-auto px-3 py-4">
        ...
        <div class="space-y-1">
            ...
            <a href="{{ route('dashboard') }}"
                class="{{ $baseLink }} {{ request()->routeIs('dashboard') ? $active : $inactive }}">
                <i class="fas fa-gauge-high w-4 text-center"></i>
                Dashboard Admin
            </a>

            <a href="{{ route('poli.index') }}"
                class="{{ $baseLink }} {{ request()->routeIs('poli.*') ? $active : $inactive }}">
            ...
            <a href="{{ route('dokter.index') }}"
                class="{{ $baseLink }} {{ request()->routeIs('dokter.index') ? $active : $inactive }}">
                <i class="fas fa-user-md w-4 text-center"></i>
                Manajemen Dokter
            </a>

            <a href="{{ route('pasien.index') }}"
                class="{{ $baseLink }} {{ request()->routeIs('pasien.index') ? $active : $inactive }}">
                <i class="fas fa-users w-4 text-center"></i>
                Manajemen Pasien
            </a>

            <a href="{{ route('pembayaran.index') }}"
                class="{{ $baseLink }} {{ request()->routeIs('pembayaran.*') ? $active : $inactive }}">
